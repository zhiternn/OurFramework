...
/*!
\brief
Finds which choice the value is closest to

\param val - the value to check
\param firstVal - the value to check
\param secondVal - the value to check
\exception None
\return firstVal or secondVal
*/
/******************************************************************************/
	template<typename T>
	T GetNearest(T val, T firstVal, T secondVal) {
		return (abs(val - firstVal) < abs(val - secondVal)) ? firstVal : secondVal;
	}

/******************************************************************************/
/*!
\brief
Finds which choice the value is furthest to
...
/******************************************************************************/
	template<typename T>
	T GetFurthest(T val, T firstVal, T secondVal) {
		return (abs(val - firstVal) > abs(val - secondVal)) ? firstVal : secondVal;
	}
