...
void Application::Init()
{
	...
	m_window = glfwCreateWindow(m_window_width, m_window_height, "OurFramework", NULL, NULL);
...
void Application::Run()
{
	...
	SceneManager::GetInstance()->SetActiveScene("SceneTemplate2D");
